...
Generate a text-free artwork layer. Return exact strings and measurable placement specifications. Mark exact copy unverified. Keep long messages out of image-model text.
...
Do not claim identity, object count, exact copy, text legibility, watermark absence, or layout safety is verified. Mark those checks declared or unverified.
...
| verified identity | inspection | declare locks and disclose unverified output |
...
The browser Studio is a deterministic local composer. It can crop, frame, reduce visually, build hybrid overlays, create a source-free procedural distillation preview, typeset locked copy, inspect its own layout measurements, and export RGB PNG. It does not generate AI imagery, semantically recognize a photograph, prove identity preservation, convert to CMYK, or certify press readiness.
