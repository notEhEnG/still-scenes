...
Treat these recipes as compatibility fallbacks. For V3 work, solve the final layout from the Scene Graph, Scene Contract, Mutation Budget, crop pressure, text pressure, quiet fields, gaze, horizon, and focal sensitivity. Record why the chosen family fits the scene.
